 ...
 */
$lang['admin_install'] = 'Εγκατάσταση';
$lang['admin_install_error'] = 'Αποτυχία εγκατάστασης του πακέτου.';
...
$lang['admin_install_success'] = 'Το πακέτο εγκαταστάθηκε με επιτυχία.';
$lang['admin_install_upload'] = 'Μεταφόρτωση';
$lang['admin_install_upload_error'] = 'Αποτυχία μεταφόρτωσης του πακέτου.';
$lang['admin_install_upload_success'] = 'Το πακέτο μεταφορτώθηκε με επιτυχία.';
...
$lang['admin_modules_install_confirm'] = 'Είστε βέβαιοι ότι θέλετε να εγκαταστήσετε αυτή τη μονάδα;';
...
$lang['admin_plugins_install_confirm'] = 'Είστε βέβαιοι ότι θέλετε να εγκαταστήσετε αυτό το πρόσθετο;';
...
$lang['admin_themes_install_confirm'] = 'Είστε βέβαιοι ότι θέλετε να εγκαταστήσετε αυτό το θέμα;';
...
$lang['admin_languages_install_confirm'] = 'Είστε βέβαιοι ότι θέλετε να εγκαταστήσετε αυτή τη γλώσσα;';
