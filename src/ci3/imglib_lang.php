...
$lang['imglib_could_not_crop'] = 'Το αρχείο εικόνας δεν μπορούσε να περικοπεί.';
$lang['imglib_could_not_resize'] = 'Το αρχείο εικόνας δεν μπόρεσε να αλλάξει μέγεθος.';
$lang['imglib_ext_not_supported'] = 'Οι %s εικόνες δεν υποστηρίζονται.';
...
$lang['imglib_image_memory_error'] = 'Δεν υπάρχει αρκετή μνήμη για την επεξεργασία αυτής της εικόνας.';
